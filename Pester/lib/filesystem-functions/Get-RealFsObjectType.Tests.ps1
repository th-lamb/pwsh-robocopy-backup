...
Describe 'Get-RealFsObjectType' {
  ...
  Context 'Existing directories/files' {
    It 'recognizes existing directory                       e.g. C:\Users\...\Music\' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Music/"
      $expected   = "directory"
    ...
    It 'recognizes existing directory with placeholder (*)  e.g. C:\Users\...\Mu*ic\' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Mu*ic/"
      $expected   = "directory"
    ...
    It 'recognizes existing file                            e.g. C:\Users\...\Music\title1.mp3' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Music/title1.mp3"
      $expected   = "file"
    ...
    It 'recognizes existing file with placeholders          e.g. C:\Users\...\Music\title*.mp3' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Music/title*.mp3"
      $expected   = "file"
  ...
  Context 'non-existent directories/files' {
    It 'recognizes non-existent directory                   e.g. C:\Users\...\Music2\' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Music2/"
      $expected   = $false
    ...
    It 'recognizes non-existent directory with placeholder  e.g. C:\Users\...\Mu*ic2\' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Mu*ic2/"
      $expected   = $false
    ...
    It 'recognizes non-existent file                        e.g. C:\Users\...\Music\title0.mp3' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Music/title0.mp3"
      $expected   = $false
  ...
  Context 'Placeholders in both, directory and filename' {
    It 'recognizes existing directory and file              e.g. C:\Users\...\Mu*ic\title1*.mp3' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Mu*ic/title1*.mp3"
      $expected   = "file"
    ...
    It 'recognizes non-existent directory                   e.g. C:\Users\...\Mu*ic2\title1*.mp3' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Mu*ic2/title1*.mp3"
      $expected   = $false
    ...
    It 'recognizes non-existent file                        e.g. C:\Users\...\Mu*ic\title0*.mp3' {
      $path_spec  = "${PSScriptRoot}/../../resources/test_files/filesystem-functions/Mu*ic/title0*.mp3"
      $expected   = $false
